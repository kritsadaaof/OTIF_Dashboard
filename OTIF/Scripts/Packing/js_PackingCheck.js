              ...
              $('#data-table-basic').dataTable().fnAddData([
                ...
                //  pr[i]["Pack_QTY"] / pr[i]["Pack_Speed"], 
                 ...
                 // CalMin(pr[i]["Pack_QTY"], pr[i]["Pack_Speed"], pr[i]["Pack_DateTime"]),
                  (pr[i]["Pack_Status_Shop"] == "T" ? '<input  class="Check" id="' + pr[i]["ID"] + '" type="checkbox" checked />' : '<input  class="Check" id="' + pr[i]["ID"] + '" type="checkbox"/>'),
                  (pr[i]["Pack_Status_QC"] == "F" ? '<i style="color:Red" class="fa fa-times"></i>' : pr[i]["Pack_Status_QC"] == "R" ? '<i style="color:Green" class="fa fa-check"></i>':"-")
              ]);
          }); Check();
      });
